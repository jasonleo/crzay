...
void HMC58X3_getRaw(int16_t *x,int16_t *y,int16_t *z) {
   ...
   i2c_read_bytes(HMC58X3_ADDR,HMC58X3_R_XM,6,vbuff);
...
{
      id[0]=i2c_read_onebyte(HMC58X3_ADDR,HMC58X3_R_IDA);  
      id[1]=i2c_read_onebyte(HMC58X3_ADDR,HMC58X3_R_IDB);
      id[2]=i2c_read_onebyte(HMC58X3_ADDR,HMC58X3_R_IDC);
}   // getID().
